...
class QuickSearch:
    ...
    def __init__(self, max_page=max_page):
        # self.sources = (VatanBilgisayar, N11, HepsiBurada, Trendyol, AmazonTR, Teknosa, GittiGidiyor,  FLO)
        self.sources = (HepsiBurada, AmazonTR, GittiGidiyor, MediaMarktTR, FLO)
