...
class MediamarktScraper(WebsiteScraper):
    ...
    def get_categories():
        categories = {
            ...
            'Notebooks': 'query={search2}&path=&searchParams=/Search.ff?query%3D{search1}%26filterTabbedCategory%3Donlineshop%26filteravailability%3D1%26filterCategoriesROOT%3DBilgisayar%25C2%25A7MediaTRtrc504925%26channel%3Dmmtrtr%26productsPerPage%3D20%26followSearch%3D9491%26disableTabbedCategory%3Dtrue&searchProfile=onlineshop',
